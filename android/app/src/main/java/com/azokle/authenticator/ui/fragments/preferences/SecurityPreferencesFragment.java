...
import com.azokle.authenticator.PassReminderFreq;
...
import com.azokle.authenticator.helpers.BiometricSlotInitializer;
import com.azokle.authenticator.helpers.BiometricsHelper;
import com.azokle.authenticator.ui.dialogs.Dialogs;
import com.azokle.authenticator.ui.preferences.SwitchPreference;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        _encryptionPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            if (!_vaultManager.getVault().isEncryptionEnabled()) {
                ...
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_AzokleAuth_AlertDialog_Warning)
        ...
        _pinKeyboardPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            ...
            Dialogs.showPasswordInputDialog(requireContext(), R.string.set_password_confirm, R.string.pin_keyboard_description, password -> {
                if (isDigitsOnly(new String(password))) {
                    ...
                    Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_AzokleAuth_AlertDialog_Error)
