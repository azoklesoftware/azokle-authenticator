...
public class VaultRepository {
    public static final String FILENAME = "azokle_auth.json";
    public static final String FILENAME_PREFIX_EXPORT = "azokleauth-export";
    public static final String FILENAME_PREFIX_EXPORT_PLAIN = "azokleauth-export-plain";
    public static final String FILENAME_PREFIX_EXPORT_URI = "azokleauth-export-uri";
    public static final String FILENAME_PREFIX_EXPORT_HTML = "azokleauth-export-html";
