...
import com.azokle.authenticator.GroupPlaceholderType;
import com.azokle.authenticator.Preferences;
import com.azokle.authenticator.R;
import com.azokle.authenticator.SortCategory;
import com.azokle.authenticator.helpers.DropdownHelper;
import com.azokle.authenticator.helpers.FabScrollHelper;
import com.azokle.authenticator.helpers.PermissionHelper;
import com.azokle.authenticator.otp.GoogleAuthInfo;
import com.azokle.authenticator.otp.GoogleAuthInfoException;
import com.azokle.authenticator.otp.OtpInfoException;
import com.azokle.authenticator.ui.dialogs.Dialogs;
import com.azokle.authenticator.ui.fragments.preferences.BackupsPreferencesFragment;
import com.azokle.authenticator.ui.fragments.preferences.PreferencesFragment;
import com.azokle.authenticator.ui.models.ErrorCardInfo;
import com.azokle.authenticator.ui.models.VaultGroupModel;
import com.azokle.authenticator.ui.tasks.QrDecodeTask;
import com.azokle.authenticator.ui.views.EntryListView;
import com.azokle.authenticator.util.TimeUtils;
import com.azokle.authenticator.util.UUIDMap;
import com.azokle.authenticator.helpers.ViewHelper;
import com.azokle.authenticator.vault.VaultEntry;
import com.azokle.authenticator.vault.VaultFile;
import com.azokle.authenticator.vault.VaultGroup;
import com.azokle.authenticator.vault.VaultRepository;
import com.azokle.authenticator.vault.VaultRepositoryException;
...
public class MainActivity extends AzokleAuthActivity implements EntryListView.Listener {
   ...
   private void updateErrorCard() {
       ...
       if (backupRes != null) {
           ...
           info = new ErrorCardInfo(text, view -> {
               Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_AzokleAuth_AlertDialog_Error)
    ...
    private void showPlaintextExportWarningOptions() {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_AzokleAuth_AlertDialog_Warning)
