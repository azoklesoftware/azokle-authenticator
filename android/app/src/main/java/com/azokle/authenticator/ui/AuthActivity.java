...
import com.azokle.authenticator.crypto.KeyStoreHandle;
import com.azokle.authenticator.crypto.KeyStoreHandleException;
import com.azokle.authenticator.crypto.MasterKey;
import com.azokle.authenticator.helpers.BiometricsHelper;
import com.azokle.authenticator.helpers.EditTextHelper;
import com.azokle.authenticator.helpers.MetricsHelper;
import com.azokle.authenticator.helpers.UiThreadExecutor;
import com.azokle.authenticator.ui.dialogs.Dialogs;
import com.azokle.authenticator.ui.tasks.PasswordSlotDecryptTask;
import com.azokle.authenticator.vault.VaultFile;
import com.azokle.authenticator.vault.VaultFileCredentials;
import com.azokle.authenticator.vault.VaultRepository;
import com.azokle.authenticator.vault.VaultRepositoryException;
import com.azokle.authenticator.vault.slots.BiometricSlot;
import com.azokle.authenticator.vault.slots.PasswordSlot;
import com.azokle.authenticator.vault.slots.Slot;
import com.azokle.authenticator.vault.slots.SlotException;
import com.azokle.authenticator.vault.slots.SlotIntegrityException;
import com.azokle.authenticator.vault.slots.SlotList;
...
public class AuthActivity extends AzokleAuthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biometricsButton.setOnClickListener(v -> {
            if (_prefs.isPasswordReminderNeeded()) {
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_AzokleAuth_AlertDialog_Warning)
    ...
    private void onInvalidPassword() {
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(AuthActivity.this, R.style.ThemeOverlay_AzokleAuth_AlertDialog_Error)
