...
import com.azokle.authenticator.crypto.SCryptParameters;
import com.azokle.authenticator.otp.OtpInfo;
import com.azokle.authenticator.ui.views.EntryHolder;
...
public abstract class AzokleAuthTest {
    ...
    protected AzokleAuthApplicationBase getApp() {
        return (AzokleAuthApplicationBase) InstrumentationRegistry.getInstrumentation().getTargetContext().getApplicationContext();
    }
