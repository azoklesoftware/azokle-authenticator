...
Issuer field in Azokle Auth is matched against for automatic selection of an icon for
...
icon pack into Azokle Auth.

### Using icon packs in Azokle Auth

Users can download an icon pack from the internet and import it into Azokle Auth
through the settings menu. Azokle Auth extracts the icon pack to
...
After that, Azokle Auth will start proposing icons for new entries if the issuer
