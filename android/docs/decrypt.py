...
# example usage: ./docs/decrypt.py --input ./app/src/test/resources/com/azokle/authenticator/importers/azokle_encrypted.json
# password: test
...
def main():
    parser = argparse.ArgumentParser(description="Decrypt an Azokle Auth vault")
    parser.add_argument("--input", dest="input", required=True, help="encrypted Azokle Auth vault file")
    parser.add_argument("--output", dest="output", default="-", help="output file ('-' for stdout)")
    args = parser.parse_args()

    # parse the Azokle Auth vault file
