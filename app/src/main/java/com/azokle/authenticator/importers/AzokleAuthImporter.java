...
import com.azokle.authenticator.helpers.ContextHelper;
...
import com.azokle.authenticator.vault.VaultEntryException;
...
public class AzokleAuthImporter extends DatabaseImporter {

    public AzokleAuthImporter(Context context) {
        super(context);
    }
    ...
    public static class EncryptedState extends State {
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showPasswordInputDialog(context, R.string.enter_password_azokleauth_title, 0, (Dialogs.TextInputListener) password -> {
                List<PasswordSlot> slots = getSlots().findAll(PasswordSlot.class);
