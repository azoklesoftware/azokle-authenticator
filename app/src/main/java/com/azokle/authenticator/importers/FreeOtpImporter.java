...
import com.azokle.authenticator.ui.tasks.PBKDFTask;
import com.azokle.authenticator.util.PreferenceParser;
...
public class FreeOtpImporter extends DatabaseImporter {
    ...
    public static class EncryptedState extends State {
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_AzokleAuth_AlertDialog_Warning)
                    ...
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                        Dialogs.showPasswordInputDialog(context, R.string.enter_password_azokleauth_title, 0, password -> {
