...
@AndroidEntryPoint
public abstract class AzokleAuthActivity extends AppCompatActivity implements VaultManager.LockListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set FLAG_SECURE on the window of every AzokleAuthActivity
