...
import com.azokle.authenticator.ui.dialogs.ChangelogDialog;
import com.azokle.authenticator.ui.dialogs.LicenseDialog;
import com.azokle.authenticator.helpers.ViewHelper;
import com.google.android.material.color.MaterialColors;

public class AboutActivity extends AzokleAuthActivity {

    private static String GITHUB = "https://github.com/azoklesoftware/azokle-authenticator";
    private static String WEBSITE_ALEXANDER = "https://azokle.com";
    private static String GITHUB_MICHAEL = "https://github.com/azoklesoftware";

    private static String MAIL_AZOKLE = "support@azokle.com";
    private static String WEBSITE_AZOKLE = "https://azokle.com/";
    private static String AZOKLEAPPS_AZOKLE = "https://azokle.com/feedback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMail.setOnClickListener(v -> openMail(MAIL_AZOKLE));

        View btnWebsite = findViewById(R.id.btn_website);
        btnWebsite.setOnClickListener(v -> openUrl(WEBSITE_AZOKLE));

        View btnRate = findViewById(R.id.btn_rate);
        btnRate.setOnClickListener(v -> openUrl(AZOKLEAPPS_AZOKLE));
