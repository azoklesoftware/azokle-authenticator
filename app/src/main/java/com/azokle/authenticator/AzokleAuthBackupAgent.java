...
public class AzokleAuthBackupAgent extends BackupAgent {
    private static final String TAG = AzokleAuthBackupAgent.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        AppDatabase appDatabase = AzokleAuthModule.provideAppDatabase(this);
        _auditLogRepository = AzokleAuthModule.provideAuditLogRepository(appDatabase);
    }
